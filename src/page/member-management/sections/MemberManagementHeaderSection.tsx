...
export const MemberManagementHeaderSection: React.FC<
  MemberManagementHeaderSectionProps
> = ({ semesterOptions, selectedYearSemester, onChangeSemester }) => {
  return (
    <Card>
      <CardHeader className="flex flex-row flex-wrap items-end justify-between gap-3">
        <div>
          ...
          <CardDescription>
            학기별 회원 기록 조회 및 상세 활동 기록을 확인합니다.
          </CardDescription>
        </div>
        <div className="flex items-center gap-2">
          <span className="text-muted-foreground text-sm">학기</span>
