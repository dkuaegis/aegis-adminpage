...
const MemberDemotionPage: React.FC = () => {
  ...
  return (
    <div className="space-y-5">
      <Card>
        <CardHeader>
          <CardTitle className="text-2xl">회원 강등</CardTitle>
          <CardDescription>
            현재 학기 회비 미납 회원을 게스트(ROLE_GUEST)로 강등합니다. 관리자(ROLE_ADMIN)는 강등 대상에서 제외됩니다.
          </CardDescription>
        </CardHeader>
      </Card>
      ...
      <Card>
        <CardHeader>
          <CardTitle>강등 실행</CardTitle>
          <CardDescription>실행 시 되돌리기 어렵습니다. 대상자 검토 후 진행하세요.</CardDescription>
        </CardHeader>
