        ...
        <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
          <div className="space-y-3 rounded-lg border p-4">
            ...
            <Select
              ...
              onValueChange={(value) =>
                onSingleMemberIdChange(value ? Number(value) : null)
              }
            >
              <SelectTrigger>
              ...
              <SelectContent>
                {memberSearchResults.map((member) => (
                  ...
                  >
                    {member.memberName} ({member.studentId ?? "-"}, ID:
                    {member.memberId})
                  </SelectItem>
                ))}
              </SelectContent>
          ...
          <div className="space-y-3 rounded-lg border p-4">
            ...
            <div className="flex flex-wrap gap-2">
              <Badge variant="secondary">
                요청 {batchResult.totalRequested}건
              </Badge>
              <Badge variant="secondary">성공 {batchResult.successCount}</Badge>
              <Badge variant="secondary">
                중복 {batchResult.duplicateCount}
              </Badge>
